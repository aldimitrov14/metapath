		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "My User Data",
									"targetURL": "#mpuserdataapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mpuserdataapp-display": {
								"semanticObject": "mpuserdataapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mp.userdataapp",
									"url": sap.ui.require.toUrl("mp/userdataapp")
								}
							}
						}
					}
